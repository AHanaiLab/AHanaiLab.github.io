...
**ICF 50年後翻訳の流れ**（icf.html）: 生活の状況を入力 → AIがICF（健康状態／心身機能b／身体構造s／活動・参加d／環境因子e／個人因子）に仮分類、充足度メーター更新 → 足りないカテゴリを質問（2〜4ターン、最大5） → 「50年後のQOLを表示」 → テクノロジーの進化に応じた2076年のQOL（いま／2076年の対比・そうなる技術・一日の物語・必要な研究）→ 関連カテゴリ・論文へ。
